export const homeObjOne = {
  ...
  lightTextDesc: false,
  topLine: '',
  headline: 'Changing Text Color based on the Background in JavaScript',
  description:
...
export const homeObjTwo = {
  ...
  lightTextDesc: true,
  topLine: '',
  headline: 'Getting Image’s Color Palette in Ruby on Rails',
  description:
...
export const homeObjThree = {
  ...
  lightTextDesc: false,
  topLine: '',
  headline: 'Get color palette of an image using ColorThief',
  description:
...
export const homeObjFive = {
  ...
  lightTextDesc: false,
  topLine: '',
  headline: 'Looking Back On What Lead Me to Start Coding Bootcamp',
  description:
